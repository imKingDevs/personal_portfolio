...
function Statics() {
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
        ...
        <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Our Happy Users</h1>
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven't heard of them man bun deep jianbing selfies heirloom prism food truck ugh squid celiac humblebrag.</p>
        </div>
        <div className="flex flex-wrap -m-4 text-center">
        <div className="p-4 md:w-1/4 sm:w-1/2 w-full ">
            <div className="border-2 border-gray-800 px-4 py-6 rounded-lg hover:bg-gray-800 hover:border-white hover:border-opacity-25">
        ...
        <div className="p-4 md:w-1/4 sm:w-1/2 w-full ">
            <div className="border-2 border-gray-800 px-4 py-6 rounded-lg hover:bg-gray-800 hover:border-white hover:border-opacity-25">
                ...
                <h2 className="title-font font-medium text-3xl text-white">1.4K</h2>
